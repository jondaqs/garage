...
import { Car, Lock, Eye, EyeOff, Loader2, CheckCircle, ShieldCheck, AlertTriangle } from 'lucide-react'
...
export default function ResetPasswordPage() {
  ...
  // Verify the user has a valid session (set by the callback after code exchange)
  useEffect(() => {
    const check = async () => {
  ...
  // No session — the user navigated here directly without going through the email link
  if (!hasSession) {
    return (

...
export default function CompanyRemindersPage() {
              ...
              <div key={rec.id}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {rec.vehicle && (
                      <button
                        onClick={() => router.push(`/company/fleet/${rec.vehicle.id}`)}
                    ...
                    <div className="flex flex-wrap gap-4 text-xs text-gray-500">
                      ...
                      {rec.work_order?.id && (
                        <button
                          onClick={() => router.push(`/company/work-orders/${rec.work_order.id}`)}
                  ...
                  {!rec.is_acknowledged && (
                    <div className="flex flex-col gap-2 flex-shrink-0">
                      <button
                        onClick={() => router.push(`/company/bookings/book?vehicle=${rec.vehicle?.id}`)}

// → Drop this file at: src/app/company/feedback/page.js
'use client'
      ...
      <div className="mb-6 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Tell us what's working, what's broken, or what would make managing your fleet easier.
          </p>
        </div>
      </div>

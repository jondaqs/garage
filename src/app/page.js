        ...
        <footer style={{
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 32, justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 32 }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 18, fontSize: 13, color: 'var(--footer-link)' }}>
                {[
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                  {social.whatsapp && (
                    <a href={social.whatsapp} target="_blank" rel="noopener noreferrer" title="WhatsApp"
                      style={{ width: 40, height: 40, borderRadius: 10, background: 'var(--feat-bg)', border: '1px solid var(--card-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'transform 0.2s, border-color 0.2s', textDecoration: 'none' }}
          ...
          <p style={{ fontSize: 13, color: 'var(--footer-copy)', textAlign: 'center', paddingTop: 16, borderTop: '1px solid var(--border)' }}>

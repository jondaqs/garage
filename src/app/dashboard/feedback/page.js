// → Drop this file at: src/app/dashboard/feedback/page.js
'use client'
...
const STATUS_LABELS = {
  ...
  in_review: { label: 'In Review',    icon: Eye,         cls: 'bg-blue-100 text-blue-700'    },
  resolved:  { label: 'Resolved',     icon: CheckCircle2,cls: 'bg-green-100 text-green-700'  },
...
export default function CustomerFeedbackPage() {
  ...
  // Capture the user's last route as the "from page" hint. /dashboard/feedback
  // itself is the obvious page; we want where they were thinking about giving
  // feedback. document.referrer is the cleanest signal we have client-side.
  useEffect(() => {

...
export default function MemberSearchProvidersPage() {
  ...
  }, [authState, search, descSearch, typeFilter, locationFilter, countryFilter, verifiedOnly, page])
        ...
        <div className="max-w-6xl mx-auto px-4 py-4">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={() => setFiltersOpen(o => !o)}
              ...
              Filters
              {(typeFilter || locationFilter || countryFilter || verifiedOnly) && <span className="w-2 h-2 rounded-full bg-orange-400" />}
            </button>
          </div>
          ...
          {filtersOpen && (
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-2 pt-3">
              ...
              {(typeFilter || locationFilter || countryFilter || verifiedOnly || descSearch || search) && (
                <button onClick={() => { setSearch(''); setDescSearch(''); setTypeFilter(''); setLocationFilter(''); setCountryFilter(''); setVerifiedOnly(false) }}
